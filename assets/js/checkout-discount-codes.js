      ...
      functionUrl,
      {
        ...
        body:
          JSON.stringify({
            ...
            /*
             * Course extensions must identify the enrollment being extended.
             * For normal services this value is null and is ignored.
             */
            enrollmentId:
              new URLSearchParams(window.location.search).get("enrollment_id") || null,
