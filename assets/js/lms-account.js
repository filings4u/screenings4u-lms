...
;
/* SOURCE: assets/js/lms-account.js */
(function(){
"use strict";
...
;
/* SOURCE: assets/js/lms-account-design.js */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const support = content ? content.querySelector('.danger-card') : null;

  if (!layout || !sidebar || !content) return;

  /* Requested: Learning Preferences directly below the profile/navigation card. */
  if (preferences) sidebar.appendChild(preferences);

  /* Requested: move support bar up so it follows the two columns immediately. */
  if (support) layout.appendChild(support);
});
